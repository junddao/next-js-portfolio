...
const items = [
  {
    ...
    title: "니가가라캠핑",
    desc: "캠핑장 예약 양도, 양수 서비스 - Flutter로 android/ios/web까지 개발",
    img: "https://images.pexels.com/photos/18073372/pexels-photo-18073372/free-photo-of-young-man-sitting-in-a-car-on-a-night-street.jpeg?auto=compress&cs=tinysrgb&w=1600&lazy=load",
    link: "https://nigagara.co.kr",
  },
  {
    id: 2,
      ...
      <div className="h-[600vh]" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center">
          <motion.div style={{ x }} className="flex">
            ...
            {items.map((item) => (
              <div
                className={`h-screen w-screen flex item-center justify-center bg-gradient-to-r ${item.color}`}
                key={item.id}
              >
